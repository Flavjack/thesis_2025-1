...
knitr::include_graphics("manuscrito/img_0.png")
```
\newpage
```{r}
...
knitr::include_graphics("manuscrito/img_1.png")
```
\newpage
```{r}
...
knitr::include_graphics("manuscrito/img_2.png")
```
\newpage
```{r}
#| label: tbl-id.fuoxt4sat4od
#| tbl-cap: "Reading materials for the journal club implemented during the academic semesters of 2021 and 2022 in the plant genetics lectures amidst the challenges of the COVID-19 pandemic."
...
\newpage
```{r}
#| label: tbl-id.es7ldr5wrwnj
#| tbl-cap: "Questions of the survey to evaluate the level of satisfaction of the journal club in the plant genetics lectures during the period 2021 and 2022."
knitr::kable(tibble::tibble(' ' = ''))
```
| **Number**                                                   | **Question**                                                  |
|--------------------------------------------------------------|---------------------------------------------------------------|
